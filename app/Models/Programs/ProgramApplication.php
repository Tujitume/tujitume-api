...
class ProgramApplication extends Model
{
    ...
    protected static function newFactory() { return \Database\Factories\ProgramApplicationFactory::new(); }
    ...
    {
        return $this->hasOne(ProgramWallet::class, 'application_id');
    }
    ...
    {
        return $this->belongsTo(ProgramRound::class, 'current_round_id');
    }
...
//    }
    ...
    {
        return $this->hasMany(ProgramMilestone::class, 'app_id')
