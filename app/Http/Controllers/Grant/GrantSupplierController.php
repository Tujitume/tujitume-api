...
use App\Models\Grants\MilestoneBudgetItem;
...
class GrantSupplierController extends Controller
{
    /**
    ...
    public function budget_item_index(GrantMilestone $milestone)
    {
    ...
    public function budget_item_store(Request $request, GrantMilestone $milestone)
    {
