...
class SupplierDirectoryController extends Controller
{
     ...
     * GET /grant/supplier-directory/{supplier_id}
     */
    ...
    /**
     * Update supplier
     * PATCH /grant/supplier-directory/{supplier_id}
     */
     ...
     * DELETE /grant/supplier-directory/{supplier_id}
     */
     ...
     * POST /grant/supplier-directory/{supplier_id}/deactivate
     */
    ...
    /**
     * Reactivate supplier
     * POST /grant/supplier-directory/{supplier_id}/activate
     */
    ...
    public function assignToMilestone(Request $request, GrantMilestone $milestone)
    {
        DB::beginTransaction();
        ...
        try {
            ...
            // 🔐 Authorization - only grant owner or applicant can assign suppliers to a milestone
