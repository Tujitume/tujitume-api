...
class RoundDocumentController extends Controller
{
     ...
     * POST /grant/applications/{application_id}/rounds/{round_id}/documents
     */
    public function store(Request $request, $applicationId, $roundId)
    {
        ...
        try {
            ...
            $round = GrantRound::findOrFail($roundId);
     ...
     * GET /grant/applications/{application_id}/rounds/{round_id}/documents
     */
    public function index($applicationId, $roundId)
    {
        ...
        try {
            ...
            // Authorization: Application owner or grant owner
            if ($application->user_id !== $userId && $application->grant->user_id !== $userId) {
                return response()->json(['error' => 'Unauthorized'], 403);
            }
    ...
    /**
     * Verify a document (Grant owner/reviewer only)
     * PATCH /grant/documents/{document_id}/verify
     */
    public function verify(Request $request, $documentId)
    {
        ...
        try {
            ...
            if ($document->application->grant->user_id !== $userId) {
                return response()->json(['error' => 'Unauthorized'], 403);
            }
    ...
    /**
     * Reject a document (Grant owner/reviewer only)
     * PATCH /grant/documents/{document_id}/reject
     */
     ...
     * DELETE /grant/documents/{document_id}
     */
