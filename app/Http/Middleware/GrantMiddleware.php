...
class GrantMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $role = $user->grant_profile?->role?->name ?? 'admin';
        $editorForbidden = ['delete-grant', 'create-grant', 'update-profile','delete/role-user','delete-user'];
        $viewerForbidden = [ 'accept', 'reject', 'update-grant', 'visibility','store-watchlist','delete/role-user','delete-user'];
