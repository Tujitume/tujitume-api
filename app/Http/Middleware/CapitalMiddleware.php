...
class CapitalMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $role = $user->capital_profile?->role?->name ?? 'admin';

        $editorForbidden = ['delete-capital', 'create-capital-offer', 'update-profile','delete/role-user','delete-user'];
        $viewerForbidden = ['accept', 'reject', 'update-capital', 'visibility', 'store-watchlist','delete/role-user','delete-user'];
