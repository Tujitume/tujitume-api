<div style="max-width:1024px;margin:auto;margin-top:4rem;background-color:white;border-radius:0.5rem;box-shadow:0 4px 6px rgba(0,0,0,0.1);overflow:hidden;">
    ...
    <div style="background-color:#14532d;padding:0.9rem 0;text-align:center;color:#ffffff;">
        ...
        <h1 style="font-size:2rem;font-weight:700;margin-top:1rem;">Payment Transferred</h1>
    </div>

    <div style="padding:20px;font-size:14px;line-height:1.6;">
        <p>Hi {{ $recipientName }},</p>

        <p>A payment has been transferred to you for <strong>{{ $grant_title }}</strong>. Please confirm receipt by clicking the button below.</p>
        ...
        <div style="text-align:center;margin-top:2rem;">
            <a href="{{ config('app.api_url') }}grant/disbursements/{{ $disbursement_id }}/supplier-confirm?token={{ $confirmation_token }}"
