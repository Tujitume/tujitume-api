...
>
    ...
    <div style="padding: 30px 20px;">
        ...
        ">Unfortunately Your Bid Has Been Rejected</h2>
        <p style="
            font-size: 16px; 
            line-height: 1.6; 
            margin-bottom: 25px;
            color: #333;
            font-family: Arial, sans-serif;
        ">Hi,<br/>Your bid to invest in <strong>{{$business_name}}</strong> has been rejected. Please bid again with appropriate details.</p>
        <div style="
            margin-top: 40px;
            padding-top: 20px;
