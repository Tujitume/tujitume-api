...
>
    ...
    >
        ...
        >
            Program Pitch Received
        </h1>
    </div>

        <div >
        <div class="content" style="padding: 20px;">
            <h2 class="email-title" style="font-size: 20px; margin-bottom: 20px;">Program Pitch Received</h2>
            <p class="email-message" style="font-size: 12px; padding-top: 10px; line-height: 0.5; margin-bottom: 30px;">Hi,a pitch was just submitted to your Program <b>{{$program}}</b> by <b>{{$SME}}</b>. Please review the pitch on Tujitume dashboard.</p>
