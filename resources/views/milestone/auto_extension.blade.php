...
<div style="max-width:1024px;margin:4rem auto;background:white;border-radius:0.5rem;box-shadow:0 4px 6px rgba(0,0,0,0.1);overflow:hidden;position:relative;">
    <div style="background-color:#14532d;padding:1rem;text-align:center;color:#fff;">
        ...
        <h1 style="font-size:2rem;font-weight:700;margin-top:1rem;">The following milestone deadline has been auto extended by 7 days</h1>
    </div>
    <div style="padding:20px;font-size:12px;line-height:1.8;">
        ...
        <div style="text-align:center;margin-top:2rem;">
            <a href="{{ $reviewUrl }}" target="_blank" style="background-color:#14532d;color:white;padding:0.75rem 1.5rem;margin-right:0.5rem;border-radius:0.5rem;text-decoration:none;font-weight:500;font-size:1rem;">Stay or Refund</a>
        </div>
