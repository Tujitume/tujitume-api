...
Route::post('register/org-team-member', [RegisterController::class, 'registerOrgTeamMember'])
    ->middleware('auth:sanctum');

Route::post('register/external-reviewer', [RegisterController::class, 'registerExternalReviewer'])
    ->middleware('auth:sanctum');
