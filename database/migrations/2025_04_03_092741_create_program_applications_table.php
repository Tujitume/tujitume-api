...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('program_applications', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('program_owner_id');               // program admin reviewing this
            ...
            $table->enum('status', [
                ...
                'approved',         // program owner approved
                'rejected',         // program owner rejected
                'waitlisted',
            ...
            $table->enum('funding_setup_status', [
                ...
                'in_progress',        // Program owner preparing milestones

                'awaiting_applicant_revision', // Program owner finalized setup, waiting for applicant revisions/submission
            ...
            $table->index(['program_owner_id', 'status']);

            $table->foreign('program_id')->references('id')->on('programs')->onDelete('restrict');
            $table->foreign('user_id')->references('id')->on('users')->onDelete('restrict');
            $table->foreign('program_owner_id')->references('id')->on('users')->onDelete('restrict');
